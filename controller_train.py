...
env = wrap_env(action_type = action_type[0], env = env, add_observation_wrappers = True, add_action_wrappers = True, add_reward_wrappers = True, lane_penalty = True)
...
print('BEST PREVIOUS AVERAGE EVAL REWARD: {}\n'.format(best_avg_reward))
...
for i_episode in itertools.count(1):
    ...
    if i_episode % 10 == 0 and args.eval == True:
        ...
        if(avg_reward > best_avg_reward):
            ...
            agent.save_model(actor_path = actor_paths, critic_path = critic_paths, reward = best_avg_reward)
        else:
            print('NO SAVE !')
            print("----------------------------------------")
